...
public enum Element {
	...
	MORT ("§7Mort§f", "§7", "§7Mort§f : vous avez §75%§f de chance d'esquiver une attaque.", Color.BLACK), 
	FEU ("§4Feu§f", "§4", "§4Feu§f : vous avez l'effet §cRésistance au Feu§f et vos armes sont §cenflammées§f.", Color.RED), 
	EAU ("§9Eau§f", "§9", "§9Eau§f : après avoir passé 3 secondes dans l'eau, vous gagnez 30 secondes de §bVitesse I§f.", Color.BLUE), 
